...
/**
 * Props for `CoverSlice`.
 */
export type CoverSliceProps = SliceComponentProps<Content.CoverSliceSlice>;

/**
 * Component for "CoverSlice" Slices.
 */
const CoverSlice = ({ slice }: CoverSliceProps): JSX.Element => {
