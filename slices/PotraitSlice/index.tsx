...
/**
 * Props for `PotraitSlice`.
 */
export type PotraitSliceProps = SliceComponentProps<Content.PotraitSliceSlice>;

/**
 * Component for "PotraitSlice" Slices.
 */
const PotraitSlice = ({ slice }: PotraitSliceProps): JSX.Element => {
