...
/**
 * Props for `CommissionSlice`.
 */
export type CommissionSliceProps =
  SliceComponentProps<Content.CommissionSliceSlice>;

/**
 * Component for "CommissionSlice" Slices.
 */
const CommissionSlice = ({ slice }: CommissionSliceProps): JSX.Element => {
